        ...
        <div class="p-6 sm:p-8 space-y-6 relative z-10">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pb-6 border-b border-gray-100 dark:border-white/5">
                <div class="flex items-center gap-4">
                    <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-tr from-amber-500 to-orange-600 text-white shadow-[0_8px_20px_rgba(249,115,22,0.2)] transition-transform duration-500 group-hover:scale-105">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                @foreach($this->stats as $dept)
                    <div class="p-4 rounded-xl border border-gray-100 dark:border-white/5 bg-gray-50/30 dark:bg-gray-800/30 transition-all hover:bg-gray-50/60 dark:hover:bg-gray-800/60 flex flex-col justify-between min-h-[90px]">
                        <div>
                            <!-- Department Info -->
                            <div class="flex items-center justify-between gap-3 mb-2.5">
                                <h3 class="text-xs font-bold text-gray-900 dark:text-white flex items-center gap-1.5">
                                    ...
                                    <span class="truncate max-w-[140px] sm:max-w-none">{{ $dept['name'] }}</span>
                                </h3>
