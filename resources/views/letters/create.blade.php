...
@section('content')
    <div x-data="createTemplateState()" class="flex-1 flex flex-col overflow-hidden">
        ...
        <form id="template-form" action="{{ route('letters.store') }}" method="POST"
            ...
            <aside
                ...
                <div
                    ...
                    <button type="submit"
                        class="w-full py-2.5 px-4 bg-amber-500 hover:bg-amber-600 text-white font-bold text-sm rounded-xl shadow-md shadow-amber-500/20 active:scale-98 transition-all cursor-pointer">
                        <i class="fa-solid fa-floppy-disk mr-1.5"></i> Save Template
                    </button>
                    <a href="{{ route('letters.index') }}"
                        class="block text-center py-2 text-sm text-slate-500 dark:text-zinc-400 hover:text-slate-800 dark:hover:text-zinc-200 transition-colors">Cancel</a>
                </div>
            </aside>
        </form>
                ...
                <div
                    ...
                    <div class="relative flex-1">
                        ...
                        <input type="text" x-model="globalVarSearch" placeholder="Filter global variables..."
                            class="w-full pl-8 pr-3 py-1.5 bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 rounded-lg text-xs text-slate-800 dark:text-zinc-200 focus:outline-none focus:border-amber-500">
                    </div>
