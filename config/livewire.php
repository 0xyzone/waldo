...
return [
    ...
    */
    ...
    'payload' => [
        ...
        'max_nesting_depth' => 50,          // Maximum depth of dot-notation property paths (RichEditor ProseMirror/TipTap JSON structures)
        'max_calls' => 100,                 // Maximum method calls per request
        'max_components' => 300,            // Maximum components per batch request
    ],
];
