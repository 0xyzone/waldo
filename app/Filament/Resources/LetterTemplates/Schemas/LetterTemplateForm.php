                                                    ...
                                                    <div class="grid grid-cols-1 gap-2 text-xs font-mono">
                                                        ...
                                                        <div class="flex flex-col gap-1 mt-2">
                                                            ...
                                                            <div class="flex flex-wrap gap-1.5">
                                                                ...
                                                                <code class="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-800 rounded font-semibold text-amber-600 dark:text-amber-400 cursor-pointer select-all" onclick="navigator.clipboard.writeText(this.innerText)">&#123;&#123; employee_job_description &#125;&#125;</code>
