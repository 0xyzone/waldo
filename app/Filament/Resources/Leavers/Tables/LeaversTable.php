                ...
                Action::make('export')
                    ...
                    ->form([
                        ...
                        Select::make('filter_year')
                            ...
                            ->native(false),
                        CheckboxList::make('filter_statuses')
                            ->label('Filter by Status (leave all unchecked to include all)')
                            ->options([
                                'pending' => 'Pending',
                                'cleared' => 'Cleared',
                                'cancelled' => 'Cancelled',
                    ...
                    ->action(function (array $data, HasTable $livewire, LeaverExportService $service) {
                        ...
                        if (! empty($data['filter_statuses'])) {
                            $query->whereIn('status', $data['filter_statuses']);
                        }
